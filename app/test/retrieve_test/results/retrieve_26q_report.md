...
**실행일**: 2026-03-14 17:59

## 요약

| ID | 제목 | 토픽 매칭 | PP | RT | Merged | LLM | Hit Rate | 누락 |
|---|---|---|---:|---:|---:|---:|---|---|
| TEST-0 | 핵심사례 — 본인 vs 대리인(위탁판매) | 본인 vs 대리인, 기간에 걸쳐 vs 한 시점 인식 + | 54 | 50 | 96 | 96 | 4/5 | B77 |
| TEST-1 | 단순 이론 질의 — 불필요 꼬리질문 방어 |  | 0 | 53 | 51 | 51 | 4/4 |  |
| TEST-2 | 완결된 복합 사례 — 불필요 체크리스트 방어 | 거래가격의 후속 변동, 변동대가 +1 | 40 | 48 | 84 | 84 | 2/2 |  |
| TEST-3 | 신종/하이브리드 사업 — Gray Area 경 | 변동대가, 신종 비즈니스 및 복합 쟁점 (Gray Ar | 36 | 47 | 77 | 77 | 2/2 |  |
| TEST-4 | 정보 부족 — 꼬리질문 필수 (라이선스) | 라이선싱, 기간에 걸쳐 vs 한 시점 인식 +1 | 50 | 51 | 92 | 92 | 3/4 | B56 |
| TEST-5 | 오도된 질문 — 단호히 비용 처리 | 계약체결 증분원가, 계약의 식별 +1 | 35 | 55 | 70 | 70 | 2/2 |  |
| SECTION-1 | 라이선싱 (접근권 vs 사용권) | 라이선싱, 거래가격 배분 +1 | 36 | 45 | 75 | 75 | 3/3 |  |
| SECTION-2 | 계약변경 (별도 계약 vs 기존 계약 수정) | 거래가격 배분, 수행의무 식별 +1 | 42 | 43 | 82 | 82 | 3/3 |  |
| SECTION-3 | 본인 대 대리인 (SW 유통) | 본인 vs 대리인, 기간에 걸쳐 vs 한 시점 인식 + | 55 | 54 | 98 | 98 | 2/2 |  |
| SECTION-4 | 미인도청구약정 (Bill-and-Hold) | 고객의 인수, 기간에 걸쳐 vs 한 시점 인식 +1 | 38 | 63 | 85 | 85 | 0/2 | B79~B82, B81 |
| SECTION-5 | 재매입약정 (콜옵션) | 재매입약정, 기간에 걸쳐 vs 한 시점 인식 +1 | 29 | 55 | 71 | 71 | 3/3 |  |
| SECTION-6 | 고객에게 지급할 대가 | 고객에게 지급할 대가, 본인 vs 대리인 +1 | 46 | 54 | 87 | 87 | 2/2 |  |
| SECTION-7 | 진행률 측정 (미설치 고가 자재) | 진행률 측정, 계약이행원가 +1 | 33 | 57 | 81 | 81 | 2/2 |  |
| SECTION-8 | 유의적인 금융요소 (선수금) | 유의적인 금융요소, 거래가격의 후속 변동 +1 | 39 | 59 | 85 | 85 | 3/3 |  |
| SECTION-9 | 고객의 권리 (중요한 권리 vs 마케팅) | 고객의 선택권, 거래가격 배분 +1 | 21 | 49 | 68 | 68 | 3/3 |  |
...
| SECTION-12 | 기간에 걸쳐 vs 한 시점 (창정비) | 수행의무 식별, 기간에 걸쳐 vs 한 시점 인식 +1 | 50 | 51 | 95 | 95 | 4/4 |  |
| SECTION-13 | 수행의무 식별 (ESS 계약 쪼개기) | 기간에 걸쳐 vs 한 시점 인식, 계약의 식별 +1 | 50 | 53 | 96 | 96 | 3/3 |  |
| SECTION-14 | 보증 (확신 vs 용역 유형) | 보증, 거래가격 배분 +1 | 32 | 49 | 69 | 69 | 4/4 |  |
| SECTION-15 | 계약체결 증분원가 (수주 비용) | 계약이행원가, 계약체결 증분원가 +1 | 28 | 59 | 69 | 69 | 3/3 |  |
| SECTION-16 | 할인액 배분 (렌탈) | 할인액의 배분, 거래가격 배분 +1 | 26 | 46 | 64 | 64 | 2/2 |  |
| SECTION-17 | 반품권이 있는 판매 (신제품) | 반품권이 있는 판매, 변동대가 +1 | 40 | 57 | 87 | 87 | 4/4 |  |
| SECTION-18 | 계약자산과 계약부채 표시 (순액 상계) | 계약의 식별, 표시 +1 | 34 | 65 | 80 | 80 | 4/4 |  |
| SECTION-19 | 계약이행원가 (교육훈련비) | 계약이행원가, 계약체결 증분원가 +1 | 35 | 61 | 78 | 78 | 4/4 |  |
| SECTION-20 | 잔여접근법 적용 한계 | 거래가격 배분, 변동대가 +1 | 35 | 43 | 73 | 73 | 3/3 |  |
...
- **matched_topics**: ['본인 vs 대리인', '기간에 걸쳐 vs 한 시점 인식', '변동대가']
- **Pinpoint (54건)**:
  - IE사례: 13건 (1115-IE-case-46, 1115-IE-case-46A, 1115-IE-case-47 +2)
  - QNA: 14건 (QNA-SSI-36941_pinpoint, QNA-SSI-38695_pinpoint, QNA-221109A_pinpoint +2)
  - 감리사례: 8건 (FSS-CASE-2024-2505-03_pinpoint, FSS-CASE-2024-2409-02_pinpoint, FSS-CASE-2022-2311-03_pinpoint +2)
  - 교육자료: 1건 (EDU-KASB-180426_pinpoint)
  - 본문/적용지침: 18건 (1115-35, 1115-37, 1115-38 +2)
- **Retriever (50건)**:
  - IE사례: 14건
  - QNA: 8건
  - 감리사례: 2건
  - 본문/적용지침: 26건
- **Merged→LLM**: 96건 → 96건
- **Expected docs hit**: 4/5 — hits=['B34~B38', 'B35', 'IE239~IE243', 'IE231~IE233'], misses=['B77']
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['거래가격의 후속 변동', '변동대가', '수행의무 식별']
- **Pinpoint (40건)**:
  - IE사례: 9건 (1115-IE-case-24, 1115-IE-case-6, 1115-IE-case-20 +2)
  - QNA: 12건 (QNA-SSI-202412046_pinpoint, QNA-SSI-38701_pinpoint, QNA-SSI-202312058_pinpoint +2)
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['변동대가', '신종 비즈니스 및 복합 쟁점 (Gray Area)', '수행의무 식별']
- **Pinpoint (36건)**:
  - IE사례: 7건 (1115-IE-case-20, 1115-IE-case-21, 1115-IE-case-23 +2)
  - QNA: 11건 (QNA-SSI-202312058_pinpoint, QNA-SSI-202312048_pinpoint, QNA-SSI-38465_pinpoint +2)
  - 감리사례: 2건 (FSS-CASE-2023-2405-01_pinpoint, FSS-CASE-2023-2405-06_pinpoint)
  - 본문/적용지침: 16건 (1115-6, 1115-24, 1115-25 +2)
- **Retriever (47건)**:
  - IE사례: 5건
  - QNA: 12건
  - 감리사례: 5건
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['라이선싱', '기간에 걸쳐 vs 한 시점 인식', '계약의 식별']
- **Pinpoint (50건)**:
  - IE사례: 11건 (1115-IE-case-55, 1115-IE-case-57, 1115-IE-case-54 +2)
  - QNA: 13건 (QNA-SSI-202412043_pinpoint, QNA-SSI-202412044_pinpoint, QNA-SSI-202312050_pinpoint +2)
  - 감리사례: 9건 (FSS-CASE-2025-2512-02_pinpoint, KICPA-CASE-2025-07_pinpoint, FSS-CASE-2023-2405-05_pinpoint +2)
...
- **Retriever (51건)**:
  ...
  - 본문/적용지침: 24건
- **Merged→LLM**: 92건 → 92건
- **Expected docs hit**: 3/4 — hits=['B54~B63', 'B58', 'B61'], misses=['B56']
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['라이선싱', '거래가격 배분', '수행의무 식별']
- **Pinpoint (36건)**:
  - IE사례: 9건 (1115-IE-case-55, 1115-IE-case-57, 1115-IE-case-54 +2)
  - QNA: 10건 (QNA-SSI-202412043_pinpoint, QNA-SSI-202412044_pinpoint, QNA-SSI-202312050_pinpoint +2)
  - 감리사례: 3건 (FSS-CASE-2025-2512-02_pinpoint, FSS-CASE-2024-2505-04_pinpoint, FSS-CASE-2023-2405-06_pinpoint)
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['고객의 인수', '기간에 걸쳐 vs 한 시점 인식', '본인 vs 대리인']
- **Pinpoint (38건)**:
  - IE사례: 9건 (1115-IE-case-13, 1115-IE-case-14, 1115-IE-case-16 +2)
  - QNA: 10건 (QNA-SSI-38679_pinpoint, QNA-SSI-38611_pinpoint, QNA-2017-I-KAQ015_pinpoint +2)
  - 감리사례: 7건 (FSS-CASE-2023-2405-05_pinpoint, KICPA-CASE-2025-07_pinpoint, FSS-CASE-2023-2405-06_pinpoint +2)
  - 교육자료: 1건 (EDU-KASB-180426_pinpoint)
  - 본문/적용지침: 11건 (1115-35, 1115-37, 1115-38 +2)
- **Retriever (63건)**:
  - IE사례: 15건
  - QNA: 15건
  - 감리사례: 8건
  - 본문/적용지침: 25건
- **Merged→LLM**: 85건 → 85건
- **Expected docs hit**: 0/2 — hits=[], misses=['B79~B82', 'B81']

### SECTION-5: 재매입약정 (콜옵션)

- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['재매입약정', '기간에 걸쳐 vs 한 시점 인식', '고객의 인수']
- **Pinpoint (29건)**:
  - IE사례: 4건 (1115-IE-case-62, 1115-IE-case-13, 1115-IE-case-14 +1)
  - QNA: 9건 (QNA-SSI-202412042_pinpoint, QNA-SSI-36951_pinpoint, QNA-2020-I-KQA006_pinpoint +2)
  - 감리사례: 4건 (FSS-CASE-2022-2311-03_pinpoint, KICPA-CASE-2025-07_pinpoint, FSS-CASE-2023-2405-05_pinpoint +1)
  - 교육자료: 2건 (EDU-KASB-181114_pinpoint, EDU-KASB-180426_pinpoint)
  - 본문/적용지침: 10건 (1115-35, 1115-37, 1115-38 +2)
- **Retriever (55건)**:
  - IE사례: 5건
  - QNA: 15건
  - 감리사례: 8건
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['고객에게 지급할 대가', '본인 vs 대리인', '계약의 식별']
- **Pinpoint (46건)**:
  ...
  - 감리사례: 10건 (KICPA-CASE-2024-28_pinpoint, FSS-CASE-2024-2505-03_pinpoint, FSS-CASE-2024-2409-02_pinpoint +2)
  - 교육자료: 1건 (EDU-KASB-BC46_pinpoint)
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['진행률 측정', '계약이행원가', '기간에 걸쳐 vs 한 시점 인식']
- **Pinpoint (33건)**:
  - IE사례: 5건 (1115-IE-case-18, 1115-IE-case-19, 1115-IE-case-13 +2)
  - QNA: 11건 (QNA-SSI-202506004_pinpoint, QNA-202504C_pinpoint, QNA-SSI-38698_pinpoint +2)
  - 감리사례: 4건 (KICPA-CASE-2025-07_pinpoint, KICPA-CASE-2025-33_pinpoint, FSS-CASE-2023-2405-05_pinpoint +1)
  - 교육자료: 1건 (EDU-KASB-180426_pinpoint)
  - 본문/적용지침: 12건 (1115-35, 1115-37, 1115-38 +2)
- **Retriever (57건)**:
  - IE사례: 19건
  - QNA: 15건
  - 감리사례: 2건
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['유의적인 금융요소', '거래가격의 후속 변동', '계약의 식별']
- **Pinpoint (39건)**:
  - IE사례: 11건 (1115-IE-case-26, 1115-IE-case-29, 1115-IE-case-28 +2)
  - QNA: 7건 (QNA-SSI-36991_pinpoint, QNA-SSI-202412046_pinpoint, QNA-SSI-38701_pinpoint +2)
  - 감리사례: 6건 (FSS-CASE-2023-2405-01_pinpoint, FSS-CASE-2024-2505-02_pinpoint, FSS-CASE-2025-2512-01_pinpoint +2)
  - 교육자료: 1건 (EDU-KASB-BC46_pinpoint)
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['고객의 선택권', '거래가격 배분', '할인액의 배분']
- **Pinpoint (21건)**:
  - IE사례: 5건 (1115-IE-case-49, 1115-IE-case-52, 1115-IE-case-50 +2)
  - QNA: 3건 (QNA-SSI-202312049_pinpoint, QNA-SSI-38671_pinpoint, QNA-SSI-38672_pinpoint)
  - 감리사례: 2건 (KICPA-CASE-2024-28_pinpoint, FSS-CASE-2024-2505-04_pinpoint)
  - 본문/적용지침: 11건 (1115-70, 1115-76, 1115-77 +2)
- **Retriever (49건)**:
  - IE사례: 21건
  - QNA: 6건
  - 감리사례: 3건
  - 본문/적용지침: 19건
- **Merged→LLM**: 68건 → 68건
- **Expected docs hit**: 3/3 — hits=['B39~B41', 'B40', 'B41'], misses=[]
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['수행의무 식별', '기간에 걸쳐 vs 한 시점 인식', '계약의 식별']
- **Pinpoint (50건)**:
  - IE사례: 10건 (1115-IE-case-11, 1115-IE-case-10, 1115-IE-case-12 +2)
  - QNA: 14건 (QNA-2018-I-KQA009_pinpoint, QNA-SSI-35609_pinpoint, QNA-SSI-36987_pinpoint +2)
  - 감리사례: 8건 (FSS-CASE-2023-2405-06_pinpoint, KICPA-CASE-2025-07_pinpoint, FSS-CASE-2023-2405-05_pinpoint +2)
  - 교육자료: 2건 (EDU-KASB-180426_pinpoint, EDU-KASB-BC46_pinpoint)
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['할인액의 배분', '거래가격 배분', '수행의무 식별']
- **Pinpoint (26건)**:
  - IE사례: 5건 (1115-IE-case-34, 1115-IE-case-33, 1115-IE-case-11 +2)
  - QNA: 7건 (QNA-SSI-38672_pinpoint, QNA-SSI-38671_pinpoint, QNA-2018-I-KQA009_pinpoint +2)
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['반품권이 있는 판매', '변동대가', '거래가격의 후속 변동']
- **Pinpoint (40건)**:
  - IE사례: 8건 (1115-IE-case-22, 1115-IE-case-26, 1115-IE-case-20 +2)
  - QNA: 12건 (QNA-SSI-38485_pinpoint, QNA-SSI-38612_pinpoint, QNA-SSI-35567_pinpoint +2)
  - 감리사례: 2건 (FSS-CASE-2024-2505-03_pinpoint, FSS-CASE-2023-2405-01_pinpoint)
  - 본문/적용지침: 18건 (1115-47, 1115-50, 1115-51 +2)
- **Retriever (57건)**:
  - IE사례: 13건
  - QNA: 15건
  - 감리사례: 1건
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['계약의 식별', '표시', '계약의 결합']
- **Pinpoint (34건)**:
  - IE사례: 7건 (1115-IE-case-2, 1115-IE-case-3, 1115-IE-case-1 +2)
  - QNA: 9건 (QNA-SSI-36917_pinpoint, QNA-SSI-36993_pinpoint, QNA-2021-I-KQA008_pinpoint +2)
  - 감리사례: 7건 (FSS-CASE-2024-2505-02_pinpoint, FSS-CASE-2025-2512-01_pinpoint, FSS-CASE-2024-2409-01_pinpoint +2)
  - 교육자료: 1건 (EDU-KASB-BC46_pinpoint)
  - 본문/적용지침: 10건 (1115-6, 1115-9, 1115-15 +2)
- **Retriever (65건)**:
  - IE사례: 10건
  - QNA: 15건
  - 감리사례: 11건
...
- **routing**: IN | **is_situation**: True | **needs_calc**: False
- **matched_topics**: ['계약이행원가', '계약체결 증분원가', '계약의 식별']
- **Pinpoint (35건)**:
  - IE사례: 6건 (1115-IE-case-36, 1115-IE-case-37, 1115-IE-case-2 +2)
  - QNA: 10건 (QNA-202003D_pinpoint, QNA-SSI-202412041_pinpoint, QNA-201906D_pinpoint +2)
  - 감리사례: 5건 (FSS-CASE-2024-2505-02_pinpoint, FSS-CASE-2025-2512-01_pinpoint, FSS-CASE-2024-2409-01_pinpoint +2)
